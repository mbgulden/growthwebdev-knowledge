---
type: Reference
title: AI SEO Strategy (GEO + AEO) — Active Oahu Tours
description: 46KB deep-dive into AI search landscape (Google AI Overviews, ChatGPT, Perplexity, Claude) and how to win citations in generative answers. Covers GEO Quick Wins (30-day plan), AEO schema priority matrix, entity optimization (Knowledge Graph + Wikidata).
tags: [aot, seo, geo, ai-seo, migrated-from-existing]
timestamp: 2026-06-19T12:28:24Z
linear_issue: null
git_path: okf/research/ai-seo-strategy.md
status: current
migrated_from: /home/ubuntu/work/hd-platform/docs/active-oahu/ai-seo-strategy.md
visibility: private
resource: okf/hubs/active-oahu/seo/research/ai-seo-strategy.md
