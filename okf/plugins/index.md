...
**New to the Prismatic Engine plugins?** Read the
[AGY Plugin Development Golden Path](./prismatic-engine-golden-path/index.md)
first. It's the master architectural document that frames all the
...
|---|---|---|
| [AGY Plugin Development Golden Path](./prismatic-engine-golden-path/index.md) | 1 | Master architectural blueprint — read this first |
