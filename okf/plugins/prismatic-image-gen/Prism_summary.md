...
type: Reference
title: "Prism summary"
description: "Mirrored from Google Drive on 2026-06-25. Source: Drive file 1JhKURYZ1I9Pj4nT0F-L2wXNyPi7BVhpGpCXikIEjmWU (modified 2026-06-14). Originally part of the Prismatic source plugin plans and AGY architecture reports."
resource: https://docs.google.com/document/d/1JhKURYZ1I9Pj4nT0F-L2wXNyPi7BVhpGpCXikIEjmWU/edit?usp=drivesdk
tags: [drive-mirror, prismatic, gemini-evaluation, agy-report, source-plugin-plans]
timestamp: 2026-06-25T04:04:14.245Z
git_repo: mbgulden/growthwebdev-knowledge
linear_issue: TBD
last_verified: 2026-06-25
verified_by: fred
status: current
drive_file_id: "1JhKURYZ1I9Pj4nT0F-L2wXNyPi7BVhpGpCXikIEjmWU"
drive_modified: "2026-06-14T06:41:04.756Z"
---
...
| ----- | ----- | ----- |
| **Engine Linker** | `./scripts/engine_audio_linker.py` | Maps custom ledgers to Unreal/Unity asset types. |
| **Voxel Auditor** | `./scripts/verify_acoustic_voxels.py` | Validates that sound doesn't "leak" through 3D meshes. |
| **VRAM Sentry** | `./scripts/audio_performance_sentry.py` | Prevents disk I/O bottlenecks and memory thrashing. |
| **Live Editor** | `./scripts/audio_live_tweak.py` | Allows real-time adjustment of AI generation seeds in-engine. |
