---
type: Reference
title: "Agy Claude Code Build Pattern"
description: "Mirrored from Google Drive on 2026-06-25. Source: Drive file 1TBn8V7tAg6Lgr8JRt9u-59yP1Lk0CvKslIPQKC28MaM (modified 2026-06-08). Originally part of the Prismatic source plugin plans and AGY architecture reports."
resource: https://docs.google.com/document/d/1TBn8V7tAg6Lgr8JRt9u-59yP1Lk0CvKslIPQKC28MaM/edit?usp=drivesdk
tags: [drive-mirror, prismatic, gemini-evaluation, agy-report, source-plugin-plans]
timestamp: 2026-06-25T04:04:33.756Z
git_repo: mbgulden/growthwebdev-knowledge
linear_issue: TBD
last_verified: 2026-06-25
verified_by: fred
status: current
drive_file_id: "1TBn8V7tAg6Lgr8JRt9u-59yP1Lk0CvKslIPQKC28MaM"
drive_modified: "2026-06-08T10:10:24.265Z"
---
...
\!\[AI Agentic Task Graph Loop\](/home/ubuntu/work/prismatic-engine/reports/images/claude\_code\_build\_pattern.png)
...
\> 2\. \*\*Task State tracking\*\*: Checklists (\`task\_list.md\`) track progress.  
...
| \*\*State Tracking\*\* | Local files, prompt caches, terminal history, markdown checklists. | Linear issue labels, SQLite (\`event\_router.db\`), issue comments. |  
...
1\. \*\*Local Self-Healing Hooks\*\*: Allow Prismatic's agent configurations to define a validation command (e.g. \`test\_command: pytest\`). If the command fails, instead of immediate failure, provide the agent with a local retry quota (e.g. \`max\_retries: 3\`) to self-heal code files before signaling completion.  
