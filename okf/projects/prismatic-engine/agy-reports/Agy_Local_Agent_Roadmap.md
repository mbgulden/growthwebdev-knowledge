---
type: Reference
title: "Agy Local Agent Roadmap"
description: "Mirrored from Google Drive on 2026-06-25. Source: Drive file 1GrtGXQffVhRtvulzpjymBxJRCJLSldAMzAoe5y-jU0I (modified 2026-06-08). Originally part of the Prismatic source plugin plans and AGY architecture reports."
resource: https://docs.google.com/document/d/1GrtGXQffVhRtvulzpjymBxJRCJLSldAMzAoe5y-jU0I/edit?usp=drivesdk
tags: [drive-mirror, prismatic, gemini-evaluation, agy-report, source-plugin-plans]
timestamp: 2026-06-25T04:04:38.899Z
git_repo: mbgulden/growthwebdev-knowledge
linear_issue: TBD
last_verified: 2026-06-25
verified_by: fred
status: current
drive_file_id: "1GrtGXQffVhRtvulzpjymBxJRCJLSldAMzAoe5y-jU0I"
drive_modified: "2026-06-08T10:10:49.103Z"
---
...
ollama run qwen2.5:7b-instruct-q5\_K\_M

\# 2\. Run Prismatic Engine initialization in standalone mode  
prismatic-engine init \--standalone

\# 3\. Enable local agent configurations in config/local\_agents.yaml:  
\# (Set endpoint to http://localhost:11434)

\# 4\. Trigger proofreader workflow on a markdown file:  
echo "This is a simple test file with spelling misteaks." \> test\_doc.md  
prismatic-engine run \--agent "local-proofreader" \--file "test\_doc.md"

\# 5\. Check test\_doc.md for updated corrections  
cat test\_doc.md  
\`\`\`
