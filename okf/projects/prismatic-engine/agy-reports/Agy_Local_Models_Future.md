---
type: Reference
title: "Agy Local Models Future"
description: "Mirrored from Google Drive on 2026-06-25. Source: Drive file 1QIXx2bOItyc5OKhtDPBT76r6Jg_bAKfF_Dh1gTqcUso (modified 2026-06-08). Originally part of the Prismatic source plugin plans and AGY architecture reports."
resource: https://docs.google.com/document/d/1QIXx2bOItyc5OKhtDPBT76r6Jg_bAKfF_Dh1gTqcUso/edit?usp=drivesdk
tags: [drive-mirror, prismatic, gemini-evaluation, agy-report, source-plugin-plans]
timestamp: 2026-06-25T04:04:40.857Z
git_repo: mbgulden/growthwebdev-knowledge
linear_issue: TBD
last_verified: 2026-06-25
verified_by: fred
status: current
drive_file_id: "1QIXx2bOItyc5OKhtDPBT76r6Jg_bAKfF_Dh1gTqcUso"
drive_modified: "2026-06-08T10:10:56.782Z"
---
...
The traditional loss of coherence at low bitrates is being resolved by \*\*Activation-Aware Quantization (AWQ)\*\* and \*\*Importance Matrix (I-Matrix) GGUF\*\* techniques. By June 2027, 2-bit quantization (\`IQ2\_XXS\` and similar) will achieve the perplexity score of today’s 4-bit quantizations, effectively doubling the parameter capacity of existing VRAM configurations.
...
\#\#\# Tier 4 (24 GB VRAM)  
\* \*\*Expected Models:\*\* Qwen 3.0 Coder 32B (Q8), Llama 3.5 70B (IQ3\_S), DeepSeek-V3-Mini (MoE with 14B active parameters, Q4).  
...
\#\#\# Tier 5 (32 GB VRAM)  
\* \*\*Expected Models:\*\* Llama 3.5 70B (Q4), Mistral Large 3 (IQ3\_S), Command R++ v2 (IQ3).  
...
\#\#\# Tier 7 (192 GB VRAM)  
\* \*\*Expected Models:\*\* DeepSeek-R2 (FP8), Llama 3.5 405B (Q4\_K\_M).  
...
\* \*\*Expected Models:\*\* Qwen 3.5 Coder 32B (FP16), Llama 4.0 70B (IQ2\_XXS/IQ3\_S), Mistral Medium 4 40B.  
