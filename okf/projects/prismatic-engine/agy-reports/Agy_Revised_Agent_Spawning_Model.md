---
type: Reference
title: "Agy Revised Agent Spawning Model"
description: "Mirrored from Google Drive on 2026-06-25. Source: Drive file 1OpfocHZ4wxzlTH3pxK2YCtaTCW6OTTo_oqkQ8Nhf0UY (modified 2026-06-08). Originally part of the Prismatic source plugin plans and AGY architecture reports."
resource: https://docs.google.com/document/d/1OpfocHZ4wxzlTH3pxK2YCtaTCW6OTTo_oqkQ8Nhf0UY/edit?usp=drivesdk
tags: [drive-mirror, prismatic, gemini-evaluation, agy-report, source-plugin-plans]
timestamp: 2026-06-25T04:04:43.799Z
git_repo: mbgulden/growthwebdev-knowledge
linear_issue: TBD
last_verified: 2026-06-25
verified_by: fred
status: current
drive_file_id: "1OpfocHZ4wxzlTH3pxK2YCtaTCW6OTTo_oqkQ8Nhf0UY"
drive_modified: "2026-06-08T10:11:09.047Z"
---
...
docker run \-d \\  
  ...
  \--cpu-shares 1024 \\  
  \--memory "2g" \\  
  \-e HERMES\_TASK\_ID="GRO-821" \\  
  \-e AGY\_ROLE="researcher" \\  
...
agents:  
  ...
  agy:  
    spawnable: true  
    max\_instances: "hardware"  
    hardware\_limits:  
      min\_free\_ram\_mb: 1024  
      max\_cpu\_load\_pct: 90  
      max\_instances\_safety\_ceiling: 16  
    capabilities: \["designer", "researcher", "reviewer"\]  
\`\`\`

\#\#\# 5.2 Revised \`agent\_status.json\`  
Since AGY and Jules can run multiple instances, \`agent\_status.json\` must track active runs in a list (array) format instead of single-value properties:

\`\`\`json  
{  
  "last\_updated": "2026-06-08T08:00:00Z",  
  "agents": {  
    "fred": {  
      "status": "idle",  
      "active\_runs": \[\]  
    ...
    "kai": {  
      ...
      "active\_runs": \[  
        {  
          "task\_id": "GRO-815",  
          "pid": 45120,  
          "started\_at": "2026-06-08T07:55:00Z"  
        }  
      \]  
    },  
    "autobot": {  
    ...
    "jules": {  
      ...
      "active\_runs": \[  
        {  
          "task\_id": "GRO-816",  
          "session\_id": "js-901b",  
          "started\_at": "2026-06-08T07:58:00Z"  
        },  
        {  
          "task\_id": "GRO-817",  
          "session\_id": "js-901c",  
          "started\_at": "2026-06-08T07:59:00Z"  
        }  
      \]  
    },  
    "agy": {  
      ...
      "active\_runs": \[  
        ...
        {  
          ...
          "pid": 45192,  
          "capability": "designer",  
          "started\_at": "2026-06-08T07:52:00Z"  
        }  
      \]  
    }  
  }  
