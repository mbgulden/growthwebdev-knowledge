---
type: Reference
title: "Alchemy Mode Fractal Complexity"
description: "Mirrored from Google Drive on 2026-06-25. Source: Drive file 13plrOw3UZ5tJdavgpUZbx0cB5OZGu4AlSVg36VaL1ec (modified 2026-06-08). Originally part of the Prismatic source plugin plans and AGY architecture reports."
resource: https://docs.google.com/document/d/13plrOw3UZ5tJdavgpUZbx0cB5OZGu4AlSVg36VaL1ec/edit?usp=drivesdk
tags: [drive-mirror, prismatic, gemini-evaluation, agy-report, source-plugin-plans]
timestamp: 2026-06-25T04:04:46.964Z
git_repo: mbgulden/growthwebdev-knowledge
linear_issue: TBD
last_verified: 2026-06-25
verified_by: fred
status: current
drive_file_id: "13plrOw3UZ5tJdavgpUZbx0cB5OZGu4AlSVg36VaL1ec"
drive_modified: "2026-06-08T10:11:22.368Z"
---
...
\*\*Solution:\*\* Lane assignment must be \*\*per-task, not per-agent\*\*. The PRISMATIC\_ENGINE.yaml needs a capability registry:
...
instances:  
  \- id: pe-1  
    ...
    priority: 1  
    agents:  
      kai: { role: writer,   max\_concurrent: 1 }  
      agy: { role: reviewer, max\_concurrent: 2 }  
  \- id: pe-2  
    pipeline: code-pipeline  
    priority: 2  
    agents:  
      fred: { role: developer, max\_concurrent: 1 }  
  \- id: pe-3  
    pipeline: design-pipeline  
    priority: 3  
    agents:  
      agy: { role: designer, max\_concurrent: 2 }  
\`\`\`
...
1\. \*\*Agent Bundles:\*\* Should the capability registry be part of PRISMATIC\_ENGINE.yaml or a separate file?  
