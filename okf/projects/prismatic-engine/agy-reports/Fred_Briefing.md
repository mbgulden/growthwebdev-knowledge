...
type: Reference
title: "Fred Briefing"
description: "Mirrored from Google Drive on 2026-06-25. Source: Drive file 1xrcVdPx2lpqP-n3nRNAcusmJVTOTIMdjBYeB61eIX7I (modified 2026-06-08). Originally part of the Prismatic source plugin plans and AGY architecture reports."
resource: https://docs.google.com/document/d/1xrcVdPx2lpqP-n3nRNAcusmJVTOTIMdjBYeB61eIX7I/edit?usp=drivesdk
tags: [drive-mirror, prismatic, gemini-evaluation, agy-report, source-plugin-plans]
timestamp: 2026-06-25T04:04:48.937Z
git_repo: mbgulden/growthwebdev-knowledge
linear_issue: TBD
last_verified: 2026-06-25
verified_by: fred
status: current
drive_file_id: "1xrcVdPx2lpqP-n3nRNAcusmJVTOTIMdjBYeB61eIX7I"
drive_modified: "2026-06-08T10:11:30.937Z"
---
...
| \`/home/ubuntu/work/prismatic-engine/prismatic/run\_records.py\` | Agent run tracking | ✅ Complete |

\#\#\# Antigravity Hub (Governance Pattern — Needs Porting)  
| File | What It Does | Needs |  
|------|-------------|-------|  
| \`Synology\_NAS/Photo/workshop/.../SwarmLockManager.ts\` | File-level mutex locks (\`acquireLock\`, \`releaseLock\`, \`isLocked\`, \`getLockOwner\`, \`releaseAllLocksForAgent\`) | Port from TS/VS Code to headless Python or wrap \`swarm.js\` |  
...
| \`.../swarm\_locks.json\` | Lock data store (currently empty \`\[\]\`) | Populate via swarm.js |
...
| \*\*Lock location\*\* | Per-checkout \`.antigravity/swarm\_locks.json\` | \*\*Centralized\*\* at \`/home/ubuntu/.antigravity/swarm\_locks.json\` (env var \`SWARM\_LOCKS\_DIR\`) |  
...
\*\*What to do:\*\*  
1\. Create \`PRISMATIC\_ENGINE.yaml\` in the active-oahu repo (see template below)  
...
\*\*PRISMATIC\_ENGINE.yaml template:\*\*  
\`\`\`yaml  
version: 1  
agents:  
  fred:  
...
locks:  
  centralized: "/home/ubuntu/.antigravity/swarm\_locks.json"  
...
1\. Refactor \`.antigravity/swarm.js\` to:  
   \- Use centralized \`/home/ubuntu/.antigravity/swarm\_locks.json\`  
...
Your existing \`run\_records.py\` and \`dispatcher.py\` already log this data. Just need a display.
...
\`\`\`  
/Synology\_NAS/Photo/workshop/Antigravity Orchestration Hub/  
...
└── .antigravity/swarm\_locks.json      \# Lock data store  
\`\`\`
...
3\. \*\*Create \`PRISMATIC\_ENGINE.yaml\`\*\* in active-oahu repo  
