...
- `hermes/fred/human-design/daily-transit-briefing` (sha256 83c5ae8370c1a909)
- `hermes/george/human-design/daily-transit-briefing` (sha256 83c5ae8370c1a909)
- `hermes/orchestrator/human-design/daily-transit-briefing` (sha256 83c5ae8370c1a909)
...
- `hermes/ned/hermes-operations/hermes-agent` (sha256 7e6be342487bb3e2)
...
- `hermes/kai/devops/qwen-llamacpp-reasoning-effort` (sha256 b1a6004c25203c6a)

### tailscale-lan-access

- `hermes/ned/devops/tailscale-lan-access` (sha256 26bf8cb0da50c56d)
- `hermes/fred/devops/tailscale-lan-access` (sha256 56c32eabcfef3a4e)
- `hermes/george/devops/tailscale-lan-access` (sha256 56c32eabcfef3a4e)
...
| api-key-handling-for-ned | unique | devops | hermes/ned/devops/api-key-handling-for-ned | 9e929eb4301e0788 |
| api-key-management | unique | devops | hermes/ned/devops/api-key-management | 8c014ab610ed44a9 |
...
| handoff-packet-independent-review | shared-2-identical | operations | hermes/fred/operations/handoff-packet-independent-review<br>hermes/orchestrator/operations/handoff-packet-independent-review | 5366a0e73aade796 |
...
| hde-guest-fleet-ops | shared-2-identical | operations | hermes/fred/operations/hde-guest-fleet-ops<br>hermes/orchestrator/operations/hde-guest-fleet-ops | 824596af458d210e |
...
| image-reading | unique | tools | hermes/kai/tools/image-reading | 05022c0ba0f501af |
...
| linear-api-operations | unique | devops | hermes/ned/devops/linear-api-operations | c123d848f1005682 |
...
| local-llm-inference-ops | unique | devops | hermes/kai/devops/local-llm-inference-ops | f040d38a4069300a |
| local-llm-provider-tuning | unique | devops | hermes/kai/devops/local-llm-provider-tuning | 29d797600261ac15 |
...
| ned-lane-discipline-check | unique | ned-lane-discipline-check | hermes/ned/ned-lane-discipline-check | 413d385a7a22b388 |
| next-action-truth-source | shared-2-identical | micro | hermes/fred/micro/next-action-truth-source<br>hermes/orchestrator/micro/next-action-truth-source | 9a5e541d3843222a |
...
| prismatic-coordination-workflows | unique | devops | hermes/george/devops/prismatic-coordination-workflows | 2b10bfb50daf1f92 |
...
| prismatic-evidence-handling | shared-2-identical | micro | hermes/fred/micro/prismatic-evidence-handling<br>hermes/orchestrator/micro/prismatic-evidence-handling | 08a65b69cb882312 |
...
| scheduled-journal-recaps | shared-2-identical | operations | hermes/fred/operations/scheduled-journal-recaps<br>hermes/orchestrator/operations/scheduled-journal-recaps | a60306856a2e51da |
...
| session-state-handoff | shared-2-identical | agent-operations | hermes/fred/agent-operations/session-state-handoff<br>hermes/orchestrator/agent-operations/session-state-handoff | 6bd9e6b3f20d514b |
...
| tailscale-lan-access | divergent-3-variants | devops | hermes/ned/devops/tailscale-lan-access<br>hermes/fred/devops/tailscale-lan-access<br>hermes/george/devops/tailscale-lan-access<br>hermes/orchestrator/devops/tailscale-lan-access<br>hermes/kai/devops/tailscale-lan-access | 26bf8cb0da50c56d |
...
| tool-parameter-required-fields-checklist | unique | micro | hermes/kai/micro/tool-parameter-required-fields-checklist | 199cf206c8e94aa0 |
