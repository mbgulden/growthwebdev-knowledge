...
- `agy/security-and-hygiene/agy-oauth-authentication` (sha256 ac119ac859dfcbb9)
...
- `prismatic/portable-skills/daily-transit-briefing` (sha256 282efd763c11cdce)

### golden-thread

- `prismatic/portable-skills/golden-thread` (sha256 6c3a4cd7dd0f8eab)
- `agy/orchestration/golden-thread` (sha256 44c4d430b8d4ca7a)
...
- `hermes/kai/devops/hermes-agent` (sha256 df1b0187c51369a7)

### human-design-transit-briefings

- `hermes/ned/human-design/human-design-transit-briefings` (sha256 d53d14c37bd08860)
- `hermes/next-step/human-design/human-design-transit-briefings` (sha256 d53d14c37bd08860)
- `hermes/fred/human-design/human-design-transit-briefings` (sha256 372b7107c2ce0f3b)
- `hermes/george/human-design/human-design-transit-briefings` (sha256 d53d14c37bd08860)
- `hermes/orchestrator/human-design/human-design-transit-briefings` (sha256 372b7107c2ce0f3b)
- `hermes/kai/human-design/human-design-transit-briefings` (sha256 d53d14c37bd08860)
- `hermes/hdengine/human-design/human-design-transit-briefings` (sha256 d53d14c37bd08860)
- `hermes/autobot/human-design/human-design-transit-briefings` (sha256 d53d14c37bd08860)

### okf-mcp-hub

- `hermes/ned/devops/okf-mcp-hub` (sha256 65f0f7c0eaecade3)
- `hermes/next-step/devops/okf-mcp-hub` (sha256 65f0f7c0eaecade3)
...
- `hermes/ned/devops/qwen-llamacpp-reasoning-effort` (sha256 cfc9e2180e939cce)
- `hermes/kai/devops/qwen-llamacpp-reasoning-effort` (sha256 15b17ec02cdaa800)

### tailscale-lan-access

- `hermes/ned/devops/tailscale-lan-access` (sha256 8453beea3f4caac8)
- `hermes/fred/devops/tailscale-lan-access` (sha256 56c32eabcfef3a4e)
- `hermes/george/devops/tailscale-lan-access` (sha256 1f75ec65a7ab426c)
- `hermes/orchestrator/devops/tailscale-lan-access` (sha256 56c32eabcfef3a4e)
- `hermes/kai/devops/tailscale-lan-access` (sha256 732b8399ee9456d4)

## Full catalog

| Skill | Status | Category | Location(s) | sha256(8) |
|---|---|---|---|---|
| active-oahu-cta-reconcile | shared-2-identical | verifiers | hermes/fred/verifiers/active-oahu-cta-reconcile<br>hermes/orchestrator/verifiers/active-oahu-cta-reconcile | 8c85f32bf97aa95d |
| active-oahu-operations | unique | tourism | hermes/kai/tourism/active-oahu-operations | 4c033491f3ed9e6b |
| ad-hoc-verification-contracts | unique | devops | hermes/ned/devops/ad-hoc-verification-contracts | aed25de2e4dcdcfc |
...
| agy-dual-image-comparison | unique | multimodal-operations | agy/multimodal-operations/agy-dual-image-comparison | 836ca27438fdca5e |
| agy-github-pr-workflow | unique | integrations-and-apis | agy/integrations-and-apis/agy-github-pr-workflow | fa5fbbb43e241f1c |
| agy-google-api-operations | unique | integrations-and-apis | agy/integrations-and-apis/agy-google-api-operations | bed6d7558bed570f |
| agy-headless-execution | unique | autonomous-execution | agy/autonomous-execution/agy-headless-execution | 9ceeebc2b4c5b374 |
| agy-image-generation | unique | multimodal-operations | agy/multimodal-operations/agy-image-generation | d0ec49d8d56b358b |
| agy-linear-integration | unique | integrations-and-apis | agy/integrations-and-apis/agy-linear-integration | ffea6f598db6a3da |
| agy-linear-task-execution-loop | unique | autonomous-execution | agy/autonomous-execution/agy-linear-task-execution-loop | abffb5235be1d3d1 |
| agy-link-audit | unique | content-and-research | agy/content-and-research/agy-link-audit | d4bfe2a0569163de |
| agy-long-running-tasks | unique | agent-orchestration | agy/agent-orchestration/agy-long-running-tasks | 251d81be4ddb1d5d |
| agy-model-routing | unique | agent-orchestration | agy/agent-orchestration/agy-model-routing | 505e6faccc6b52a4 |
| agy-native-mcp-integration | unique | integrations-and-apis | agy/integrations-and-apis/agy-native-mcp-integration | af7776071e154de8 |
| agy-oauth-authentication | divergent-2-variants | flat, security-and-hygiene | prismatic/portable-skills/agy-oauth-authentication<br>agy/security-and-hygiene/agy-oauth-authentication | 58c6ea28ce5fa3c7 |
| agy-sandbox-security | unique | security-and-hygiene | agy/security-and-hygiene/agy-sandbox-security | 0539eabf98a791c1 |
| agy-screenshot-capture | unique | multimodal-operations | agy/multimodal-operations/agy-screenshot-capture | f87290beee8f359d |
| agy-session-recovery | unique | autonomous-execution | agy/autonomous-execution/agy-session-recovery | f6dfba484f567bd3 |
| agy-subagent-communication | unique | agent-orchestration | agy/agent-orchestration/agy-subagent-communication | bb7ba4e89e0f3289 |
| agy-systematic-debugging | unique | software-development | agy/software-development/agy-systematic-debugging | e421703550238517 |
| agy-test-driven-development | unique | software-development | agy/software-development/agy-test-driven-development | 02ee6b13dd852938 |
| alchemy-quality-gates | unique | flat | prismatic/engine-skills/alchemy-quality-gates | b950fab352b29f96 |
| antigravity-prismatic-pr-evidence | shared-2-identical | flat | prismatic/prismatic-skill-pkg/antigravity-prismatic-pr-evidence<br>prismatic/agents-skills/antigravity-prismatic-pr-evidence | f4c40c76986a47eb |
| aot-agent-coordination | unique | flat | prismatic/portable-skills/aot-agent-coordination | 2e5963f9285c53df |
| api-key-handling-for-ned | unique | devops | hermes/ned/devops/api-key-handling-for-ned | 7b8bb518e3e570f0 |
| api-key-management | unique | devops | hermes/ned/devops/api-key-management | 8411122f24002180 |
| authorized-destructive-action-verification | shared-2-identical | agent-operations | hermes/fred/agent-operations/authorized-destructive-action-verification<br>hermes/orchestrator/agent-operations/authorized-destructive-action-verification | bbacc19f04a04177 |
| autonomous-execution-discipline | divergent-2-variants | autonomous-execution, flat | prismatic/portable-skills/autonomous-execution-discipline<br>agy/autonomous-execution/autonomous-execution-discipline | 5c43fce18b0c9ddb |
| autonomous-task-ownership-validation | unique | autonomous-task-ownership-validation | hermes/ned/autonomous-task-ownership-validation | 5132d3bab1ce41ff |
| bearer-token-via-shell-substitution | unique | operations | hermes/george/operations/bearer-token-via-shell-substitution | c1248073621b3e65 |
| branch-deletion-approval | shared-2-identical | micro | hermes/fred/micro/branch-deletion-approval<br>hermes/orchestrator/micro/branch-deletion-approval | c243b425a51433b2 |
| checkout-onboarding-routing-ops | shared-2-identical | operations | hermes/fred/operations/checkout-onboarding-routing-ops<br>hermes/orchestrator/operations/checkout-onboarding-routing-ops | 23d60e143c9896ed |
| client-discovery-intelligence-repos | shared-2-identical | operations | hermes/fred/operations/client-discovery-intelligence-repos<br>hermes/orchestrator/operations/client-discovery-intelligence-repos | f18e191671d224d7 |
...
| cloudflare-pages-workers-build-checks | unique | devops | hermes/ned/devops/cloudflare-pages-workers-build-checks | 1519d5e034e13e5c |
...
| cron-scanner-bypass | unique | agent-orchestration | agy/agent-orchestration/cron-scanner-bypass | 11c013b35863c000 |
| cross-repo-branch-linear-reconciliation | unique | project-management | hermes/ned/project-management/cross-repo-branch-linear-reconciliation | 9539c6e3f30260c0 |
| daily-transit-briefing | divergent-3-variants | flat, human-design | hermes/ned/human-design/daily-transit-briefing<br>hermes/next-step/human-design/daily-transit-briefing<br>hermes/fred/human-design/daily-transit-briefing<br>hermes/george/human-design/daily-transit-briefing<br>hermes/orchestrator/human-design/daily-transit-briefing<br>hermes/kai/human-design/daily-transit-briefing<br>hermes/hdengine/human-design/daily-transit-briefing<br>hermes/autobot/human-design/daily-transit-briefing<br>prismatic/portable-skills/daily-transit-briefing | 83c5ae8370c1a909 |
| dev-troubleshooting-patterns | shared-2-identical | devops | hermes/fred/devops/dev-troubleshooting-patterns<br>hermes/orchestrator/devops/dev-troubleshooting-patterns | b11c30dd54253963 |
| directive-then-execute | shared-2-identical | micro | hermes/fred/micro/directive-then-execute<br>hermes/orchestrator/micro/directive-then-execute | d55fec878f58efc3 |
| dispatcher-label-mapping | unique | dispatcher-label-mapping | hermes/autobot/dispatcher-label-mapping | 533ce78fe7d1d2fb |
| evidence-no-secret-marker | shared-2-identical | verifiers | hermes/fred/verifiers/evidence-no-secret-marker<br>hermes/orchestrator/verifiers/evidence-no-secret-marker | 28e53681308ae71e |
| expert-interview-content-production | unique | flat | prismatic/portable-skills/expert-interview-content-production | 7893780d836dd05a |
| finalize-task-script-bug | unique | finalize-task-script-bug | hermes/ned/finalize-task-script-bug | 5113f4aa64295f63 |
| gap-closure-discipline | shared-2-identical | agent-operations | hermes/fred/agent-operations/gap-closure-discipline<br>hermes/orchestrator/agent-operations/gap-closure-discipline | a2eab64d6e178958 |
| gateway-self-restart-guard | shared-2-identical | operations | hermes/fred/operations/gateway-self-restart-guard<br>hermes/orchestrator/operations/gateway-self-restart-guard | 86979e12add7bed7 |
| github-pr-backlog-hygiene | unique | devops | hermes/ned/devops/github-pr-backlog-hygiene | 02da0f0956011438 |
| github-pr-workflow | unique | flat | prismatic/portable-skills/github-pr-workflow | f41117e2498e74d9 |
| golden-thread | divergent-2-variants | flat, orchestration | prismatic/portable-skills/golden-thread<br>agy/orchestration/golden-thread | 6c3a4cd7dd0f8eab |
| golden-thread-strategy-pipeline | shared-2-identical | operations | hermes/fred/operations/golden-thread-strategy-pipeline<br>hermes/orchestrator/operations/golden-thread-strategy-pipeline | 5de1a4a7fbaeb280 |
| google-marketing-api-operations | unique | devops | hermes/ned/devops/google-marketing-api-operations | ac4a0b5584e4f096 |
| handoff-packet-independent-review | shared-2-identical | operations | hermes/fred/operations/handoff-packet-independent-review<br>hermes/orchestrator/operations/handoff-packet-independent-review | d7c2ac70cb53fcfd |
| hd-guest-fleet-ops | shared-2-identical | operations | hermes/fred/operations/hd-guest-fleet-ops<br>hermes/orchestrator/operations/hd-guest-fleet-ops | 66f59296d39d41b4 |
| hde-google-stack-operations | unique | devops | hermes/ned/devops/hde-google-stack-operations | eab90179eba40a4f |
...
| human-design-transit-briefings | divergent-2-variants | human-design | hermes/ned/human-design/human-design-transit-briefings<br>hermes/next-step/human-design/human-design-transit-briefings<br>hermes/fred/human-design/human-design-transit-briefings<br>hermes/george/human-design/human-design-transit-briefings<br>hermes/orchestrator/human-design/human-design-transit-briefings<br>hermes/kai/human-design/human-design-transit-briefings<br>hermes/hdengine/human-design/human-design-transit-briefings<br>hermes/autobot/human-design/human-design-transit-briefings | d53d14c37bd08860 |
| hybrid-attention-llm-quantization | shared-2-identical | operations | hermes/fred/operations/hybrid-attention-llm-quantization<br>hermes/orchestrator/operations/hybrid-attention-llm-quantization | 8b0ee1a63f9c98d7 |
| image-reading | unique | tools | hermes/kai/tools/image-reading | 863a258291944f68 |
| isolated-pr-from-entangled-branch | shared-2-identical | micro | hermes/fred/micro/isolated-pr-from-entangled-branch<br>hermes/orchestrator/micro/isolated-pr-from-entangled-branch | e71bdda88361c1ae |
| jquery-wordpress-export-fix | unique | jquery-wordpress-export-fix | hermes/kai/jquery-wordpress-export-fix | 1020abc984687916 |
| kai-css-agent | unique | flat | prismatic/portable-skills/kai-css-agent | fd0a9edbe1ed1aed |
| kpis-and-reporter-architecture | unique | kpis-and-reporter-architecture | hermes/ned/kpis-and-reporter-architecture | 0347f49399d6a894 |
| lane-governance | unique | flat | prismatic/engine-skills/lane-governance | ef5bcceb6d645674 |
| linear | unique | flat | prismatic/portable-skills/linear | 60b78ce29a7e5f1f |
| linear-api-operations | unique | devops | hermes/ned/devops/linear-api-operations | 407660f9fa35c077 |
...
| mobile-nav-visual-verification | shared-2-identical | qa | hermes/george/qa/mobile-nav-visual-verification<br>hermes/kai/qa/mobile-nav-visual-verification | f667038174f34f0e |
| multi-source-reconciliation-packet | unique | project-management | hermes/ned/project-management/multi-source-reconciliation-packet | c7d61a1c974a20a0 |
| multirepo-file-find | shared-2-identical | micro | hermes/fred/micro/multirepo-file-find<br>hermes/orchestrator/micro/multirepo-file-find | 18a648b0f4dcc21c |
| ned-finalize-env-home-pitfall | unique | finalize-task-script-bug | hermes/ned/finalize-task-script-bug/ned-finalize-env-home-pitfall | 43d5498d2742dbb5 |
| ned-lane-discipline-check | unique | ned-lane-discipline-check | hermes/ned/ned-lane-discipline-check | 1985ff28e21a54d7 |
| next-action-truth-source | shared-2-identical | micro | hermes/fred/micro/next-action-truth-source<br>hermes/orchestrator/micro/next-action-truth-source | e1454f639761a831 |
| next-step-bot | unique | flat | prismatic/portable-skills/next-step-bot | 9849288bac9cdad4 |
| okf-documentation-ops | shared-2-identical | operations | hermes/fred/operations/okf-documentation-ops<br>hermes/orchestrator/operations/okf-documentation-ops | 85abaace2f1f1ab8 |
| okf-knowledge-capture | unique | knowledge-management | hermes/ned/knowledge-management/okf-knowledge-capture | 4ea415af1acf6b34 |
| okf-mcp-hub | divergent-2-variants | devops | hermes/ned/devops/okf-mcp-hub<br>hermes/next-step/devops/okf-mcp-hub<br>hermes/fred/devops/okf-mcp-hub<br>hermes/george/devops/okf-mcp-hub<br>hermes/orchestrator/devops/okf-mcp-hub<br>hermes/kai/devops/okf-mcp-hub<br>hermes/autobot/devops/okf-mcp-hub | 65f0f7c0eaecade3 |
...
| personal-named-recipient-telegram-briefings | shared-2-identical | personal-named-recipient-telegram-briefings | hermes/fred/personal-named-recipient-telegram-briefings<br>hermes/orchestrator/personal-named-recipient-telegram-briefings | fcddb09da1d9cd67 |
| plan-reconciliation-after-peer-review | shared-2-identical | operations | hermes/fred/operations/plan-reconciliation-after-peer-review<br>hermes/orchestrator/operations/plan-reconciliation-after-peer-review | eb6f78967721a9ff |
| post-edit-verification-guardrails | unique | micro | hermes/george/micro/post-edit-verification-guardrails | 313bb5966535d8d4 |
| post-session-review | shared-2-identical | micro | hermes/fred/micro/post-session-review<br>hermes/orchestrator/micro/post-session-review | aa900018e3a7d7d7 |
| prismatic-7-step-loop | unique | flat | prismatic/engine-skills/prismatic-7-step-loop | d2d85c5685e3e007 |
| prismatic-admission-control-gates | unique | devops | hermes/george/devops/prismatic-admission-control-gates | 496f9aefaa52bc55 |
| prismatic-admission-launcher-review | unique | devops | hermes/george/devops/prismatic-admission-launcher-review | 2de12f07b1e60b33 |
| prismatic-agent-closeout-contract | shared-2-identical | flat | prismatic/prismatic-skill-pkg/prismatic-agent-closeout-contract<br>prismatic/agents-skills/prismatic-agent-closeout-contract | 9f9f29f057ab334e |
| prismatic-agent-factory | unique | flat | prismatic/portable-skills/prismatic-agent-factory | a6dca2159faa7647 |
| prismatic-agy-execution | shared-2-identical | flat | prismatic/prismatic-skill-pkg/prismatic-agy-execution<br>prismatic/agents-skills/prismatic-agy-execution | 7923600e919f019e |
| prismatic-artifact-publisher | unique | flat | prismatic/portable-skills/prismatic-artifact-publisher | f7d81685c1af1ae1 |
| prismatic-completed-work-packet | unique | flat | prismatic/portable-skills/prismatic-completed-work-packet | 8a937dbc16eab1bf |
| prismatic-context-discipline | shared-2-identical | flat | prismatic/prismatic-skill-pkg/prismatic-context-discipline<br>prismatic/agents-skills/prismatic-context-discipline | 372b441a2ab419c6 |
| prismatic-coordination-workflows | unique | devops | hermes/george/devops/prismatic-coordination-workflows | a085dc22d472e659 |
| prismatic-core-skill-distribution-ops | shared-2-identical | operations | hermes/fred/operations/prismatic-core-skill-distribution-ops<br>hermes/orchestrator/operations/prismatic-core-skill-distribution-ops | 23b08de134d39568 |
...
| stripe-payment-live-operations | unique | devops | hermes/ned/devops/stripe-payment-live-operations | 7d5f50b8b603103d |
| subagent-claim-verification-gate | shared-2-identical | flat | prismatic/prismatic-skill-pkg/subagent-claim-verification-gate<br>prismatic/agents-skills/subagent-claim-verification-gate | 6cfc94265369ee07 |
| swarm-journal-ops | unique | devops | hermes/kai/devops/swarm-journal-ops | 0d858de08a09a2a2 |
| swarm-primitive-lifecycle-and-deployment | unique | flat | prismatic/agents-skills/swarm-primitive-lifecycle-and-deployment | aa028b3563058f63 |
| systematic-debugging | unique | flat | prismatic/portable-skills/systematic-debugging | c1d66056ce0b4ec8 |
...
| worktree-hygiene-and-cleanup-safety | unique | devops | hermes/ned/devops/worktree-hygiene-and-cleanup-safety | c4701e0ef517c9bf |
